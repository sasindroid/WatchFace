...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int SYNC_INTERVAL = 60 * 180; // 60 * 1;
...
//                    .appendQueryParameter(APPID_PARAM, "<app_id>")
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                // Update the Wear/Watch Data Map.
                updateWearData();
            }
    ...
    private void updateWearData() {
        ...
        // Start an Intent Service to perform this data map update in background.
        // MyWatchService class will get the latest data from database and create the datamap request.
        Intent myServiceIntent = new Intent(getContext(), MyWatchService.class);
        myServiceIntent.setAction(MyWatchService.ACTION_UPDATE_WEAR_DATA);
        getContext().startService(myServiceIntent);
    }
